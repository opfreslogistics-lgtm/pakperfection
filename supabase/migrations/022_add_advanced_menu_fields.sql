-- ================================================================
-- ADVANCED MENU FIELDS MIGRATION
-- Adds all fields for mega advanced menu management
-- ================================================================

-- Section 1: Basic Details (already exist, just ensuring)
-- name, description, category_id, price, image_url ✓

-- Add promo_price for Section 1
